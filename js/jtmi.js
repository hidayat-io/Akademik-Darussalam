	...
	if($("#add_keluarga_santri").valid()==true)
	{
		...
		if(cekItem(kdkel)==true)
		{
			...
			// {
					...
					$.ajax({
						url: base_url+'tmi/upload_lamp_keluarga',
						type: 'post',
						enctype: 'multipart/form-data',
						contentType: false,
						processData: false,
...
function view(no_registrasi){
	...
	$.ajax({
		...
		type:"POST",
		url:base_url+"tmi/get_data_santri/"+no_registrasi,
		dataType:"html",
		success:function(data){
	...
	$.ajax({
		...
		type:"POST",
		url:base_url+"tmi/get_data_keluarga/"+no_registrasi,
		dataType:"html",
		success:function(data){
	...
	$.ajax({
		...
		type:"POST",
		url:base_url+"tmi/get_data_penyakit/"+no_registrasi,
		dataType:"html",
		success:function(data){
	...
	$.ajax({
		...
		type:"POST",
		url:base_url+"tmi/get_data_kecakapankhusus/"+no_registrasi,
		dataType:"html",
		success:function(data){
...
function hapus(no_registrasi){
	...
	bootbox.confirm("Anda yakin akan menghapus "+no_registrasi+" ini ?",
		function(result){
			...
			$.ajax({
			type:"POST",
			url:base_url+"tmi/DelSantri/"+no_registrasi,
			dataType:"html",
			success:function(data){
					bootbox.alert({
...
function downloadExcel(){
	...
	window.location = base_url+'tmi/exportexcel/'+param;
}
