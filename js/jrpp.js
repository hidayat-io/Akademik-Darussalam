...
function edit(kode_kelas,tingkat, tipe_kelas,nama,santri,id_thn_ajar,deskripsi,semester){
	...
	var str_url  	= encodeURI(base_url+"rpp/GetKurikulum/"+id_thn_ajar+"/"+semester+"/"+tingkat+"/"+tipe_kelas+"/"+kode_kelas+"/"+santri);
	$.ajax({
...
// function edit(kode_kelas,tingkat, tipe_kelas,nama,santri,id_thn_ajar,deskripsi,semester){
	// 	// var str_url  	= encodeURI(base_url+"rpp/get_data_rpp/"+kode_kelas+'/'+santri+'/'+id_thn_ajar+'/'+semester);
	// 	$('#save_button').text('UPDATE');
	// 	$('#button_refresh').attr('disabled',true);
	...
	// 			var str_url  	= encodeURI(base_url+"rpp/GetKurikulum/"+id_thn_ajar+"/"+semester+"/"+tingkat+"/"+tipe_kelas);
	// 			$.ajax({
...
function hapus(kode_kelas,santri,id_thn_ajar,deskripsi,semester){
	var str_url  	= encodeURI(base_url+"rpp/Delrpp/"+kode_kelas+'/'+santri+'/'+id_thn_ajar+'/'+semester);
...
// function CekDuplicate(id_jadwal){
	...
	// 		type:"POST",
	// 		url:base_url+"rpp/get_data_rpp/"+id_jadwal,
	// 		dataType:"html",
	// 		success:function(data){				
	//             var data =	 $.parseJSON(data)
	// 		}
