...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 13, 2017 at 06:14 PM
...
(14, 3, 'Daftar Santri Aitam', 'aitam', 'glyphicon glyphicon-minus', 0),
(15, 3, 'Daftar Santri TMI', 'tmi', 'glyphicon glyphicon-minus', 0),
...
(38, 1, 'Pendafataran TMI', 'pendaftaran', 'fa fa-pencil-square-o', 1),
(39, 1, 'Pendafataran AITAM', 'pendaftaran/aitam', 'fa fa-pencil-square-o', 2);
...
CREATE TABLE `trans_rpp` (
  ...
  `id_thn_ajar` int(11) DEFAULT NULL,
  `santri` varchar(45) DEFAULT NULL,
...
CREATE TABLE `trans_rpp_detail` (
  ...
  `hari` varchar(10) DEFAULT NULL,
  `hissos` varchar(45) DEFAULT NULL,
  `materi_pokok` varchar(100) DEFAULT NULL,
  `alokasi_waktu` varchar(11) DEFAULT NULL,
...
--
ALTER TABLE `modul`
  MODIFY `modul_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
--
...
--
ALTER TABLE `trans_jadwal_pelajaran`
  MODIFY `id_jadwal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=242;COMMIT;
