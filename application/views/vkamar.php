    ...
    <div class="col-md-12">
        ...
        <div class="portlet-title">
                ...
                <div class="btn-group btn-group-sm button-tools pull-right" style="padding-top: 7px">
                    <button class="btn btn-default " type="button" data-toggle="dropdown" onclick="addkamar()">
                                    ...
                                    <div class="form-body">                                
                                        ...
                                        <form action="#" id="add_kamar">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" class="btn green" id="save_button" onclick="svkamar()">Save</button>
                                            </div>
                                        </form>
                                        <!-- END FORM-->
                                    </div>
