...
<script src="<?php echo base_url(); ?>js/jaitam.js"></script>
                                ...
                                <div class="form-body">
                                        ...
                                        <div class="m-grid m-grid-responsive-xs">
                                            <div class="m-grid-row">
                                                ...
                                                <div class="m-grid-col m-grid-col-middle m-grid-col-center col-md-2">
                                                    <div class="form-group"> <label for="form_control_1">Gedung</label>
...
<!-- modal add KELUARGA -->
    <div class="modal fade bs-modal-lg" id="Modal_add_keluarga_santri" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
