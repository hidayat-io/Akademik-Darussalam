...
<link href="<?php echo base_url(); ?>assets/css/googlefont.css" rel="stylesheet" type="text/css" />
...
<link href="<?php echo base_url(); ?>assets/plugins/bootstrap-datepicker/css/bootstrap-datepicker.css" rel="stylesheet" type="text/css" />
...
<style type="text/css">.input-group-addon {min-width:160px;text-align:left;}</style>
<!-- END THEME GLOBAL STYLES -->

<!-- BEGIN THEME LAYOUT STYLES -->
<link href="<?php echo base_url(); ?>assets/css/layout.min.css" rel="stylesheet" type="text/css" />
<link href="<?php echo base_url(); ?>assets/css/darussalam.css" rel="stylesheet" type="text/css" id="style_color" />
