...
<script src="<?php echo base_url(); ?>js/jbagian.js"></script>
    ...
    <div class="col-md-12">
        ...
        <div class="portlet-title">
                ...
                <div class="btn-group btn-group-sm button-tools pull-right" style="padding-top: 7px">
                    <button class="btn btn-default " type="button" data-toggle="dropdown" onclick="addbagian()">
...
<!-- modal add Bagian -->
    <div class="modal fade draggable-modal" id="Modal_add_bagian" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                        ...
                        <div class="portlet light portlet-fit portlet-form bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red sbold uppercase">INPUT DATA BAGIAN</span>
                                    </div>
                                </div>
                                <div class="portlet-body">
                                    <div class="form-body">                                
                                        ...
                                        <form action="#" id="add_bagian">
                                            <!--inputbox-->
                                                <!--span-->
                                                    <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="kode_bagian" id="kode_bagian" onkeydown="OtomatisKapital(this)" maxlength="10" required></div>
                                                    </div>
                                                <!--span-->
                                                    <div class="form-group">
                                                        <label class="control-label"></label>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" class="btn green-jungle" id="save_button" onclick="svbagian()">Save</button>
                                            </div>
                                        </form>
                                        <!-- END FORM-->
                                    </div>
                                            ...
                                            <!--inputbox-->
                                                <!--span-->
                                                    <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="s_kodebagian" id="s_kodebagian" onkeydown="OtomatisKapital(this)" required></div>
                                                    </div>
                                                <!--span-->
                                                    <!-- <div class="form-group">
                                                        <label class="control-label"></label>
