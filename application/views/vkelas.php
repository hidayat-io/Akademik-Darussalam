    ...
    <div class="col-md-12">
        ...
        <div class="portlet-title">
                ...
                <div class="btn-group btn-group-sm button-tools pull-right" style="padding-top: 7px">
                    <button class="btn btn-default " type="button" data-toggle="dropdown" onclick="addkelas()">
                                            ...
                                            <!--inputbox-->
                                                <!--span-->
                                                    <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="kode_kelas" id="kode_kelas" onkeydown="OtomatisKapital(this)" maxlength="10" required></div>
                                                    </div>
                                                <!--span-->
                                                    <div class="form-group">
                                                        <label class="control-label"></label>
