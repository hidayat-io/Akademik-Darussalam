...
<script src="<?php echo base_url(); ?>js/jsiswa.js"></script>
...
<!--modal untuk add new santri mulai######################################################################################################################## -->
    <div class="modal fade" id="Modal_add_Santri" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog modal-full">
            <div class="modal-content">
                <div class="modal-header ">
                    ...
                    <button type="button" class="btn green" id="save_button_header" onclick="svSantri()">Save changes</button>
                                ...
                                <div class="form-body">
                                        ...
                                        <div class="m-grid m-grid-responsive-xs">
                                            <div class="m-grid-row">
                                                ...
                                                <div class="m-grid-col m-grid-col-middle m-grid-col-center col-md-1">
                                                    <div class="form-group"> <label for="form_control_1">Kelas</label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <label class="control-label col-md-3"></label>
                                                    ...
                                                    <input type="text" class="form-control" name="dibesarkan_di" id="dibesarkan_di" required></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3"></label>
                                                                <div class="col-md-9">
                                                                    ...
                                                                    <input type="text" class="form-control" name="kelainan_fisik" id="kelainan_fisik" required></div>
                                                                </div>
                                                        </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3"></label>
                                                                ...
                                                                <input type="text" class="form-control" name="sebab" id="sebab" required></div>
                                                                </div>
                                                        </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <label class="control-label col-md-3"></label>
                                                                <div class="col-md-9">
                                                                   ...
                                                                   Akibat
                                                                    ...
                                                                    <input type="text" class="form-control" name="akibat" id="akibat" required></div>
                                                                </div>
                                                        </div>
                                                        </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3"></label>
                                                                ...
                                                                <input type="text" class="form-control" name="alergi" id="alergi" required></div>
                                                                </div>
                                                        </div>
                                                        </div>
                                                    <!--span-->
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3"></label>
                                                                <div class="col-md-9">
                                                                    ...
                                                                    <input type="text" class="form-control" name="thn_fisik" id="thn_fisik" required></div>
                                                                </div>
                                                        </div>
                                                        </div>
                                                        </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn dark btn-outline" data-dismiss="modal">Close</button>
                    <!-- <button type="submit" class="btn green" >Save changes</button> -->
                    <button type="button" class="btn green" id="save_button_footer" onclick="svSantri()">Save changes</button>
                </div>
            </form>
            </div>
            <!-- /.modal-content -->
...
<!-- modal add KELUARGA -->
    <div class="modal fade draggable-modal" id="Modal_add_keluarga_santri" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
...
<!-- modal add PENYAKIT -->
<div class="modal fade draggable-modal" id="Modal_add_penyakit" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
...
<div class="modal fade draggable-modal" id="Modal_add_KecakapanKhusus" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
