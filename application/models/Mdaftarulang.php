...
class Mdaftarulang extends CI_Model 
{
    ...
    function query_data_santri($no_registrasi){
        // $data = array();
		$data=$this->db->query("SELECT * from ms_santri where no_registrasi ='$no_registrasi' and no_registrasi NOT LIKE 'CT%' and no_registrasi NOT LIKE 'A%' AND no_registrasi NOT LIKE 'CA%' AND keterangan is NULL")->row();
		return $data;
	}  
