...
class lsuratpermohonan extends IO_Controller
{
	...
	public function __construct()
	{
			...
			parent::__construct($this->modul);
			 $this->load->model('mlsuratpermohonan','model');
	...
	function index()
	{
	    ...
	    $data['content'] = $this->load->view('vlsuratpermohonan',$vdata,TRUE);
	...
	function print_spkafalah($no_registrasi){
		...
		// $this->load->view('vPrintlsuratpermohonan',$data);
		// $this->pdf->load_view('vPrintlsuratpermohonan');
		$this->pdf->load_view('vPrintlsuratpermohonan',$data);
