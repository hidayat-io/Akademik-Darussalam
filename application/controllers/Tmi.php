...
class Tmi extends IO_Controller
{
	...
	public function __construct()
	{
			...
			parent::__construct($modul);
		 	$this->load->model('mtmi','model');
	}

	function index()
	{
		
		$vdata['title'] = 'DATA TMI';
	    $data['content'] = $this->load->view('vtmi',$vdata,TRUE);
	...
	function exportexcel(){
		...
		//name the worksheet
		$this->excel->getActiveSheet()->setTitle('TMI');
		$this->excel->getActiveSheet()->setCellValue('A1', "LIST TMI");
		...
		$filename='TMI.xls'; //save our workbook as this file name
	...
	function addtosantri(){
		...
		// var_dump($no_registrasi);
			...
			$data_santri['no_registrasi'] = $no_registrasi_baru;

			if($no_stambuk=='')$no_stambuk=$this->no_stambuk($kategori_santri);
