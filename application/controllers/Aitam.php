...
class Aitam extends IO_Controller
{
	...
	function index()
	{
	    ...
	    $data['content'] = $this->load->view('vaitam',$vdata,TRUE);
	...
	function exportexcel(){
		...
		//name the worksheet
		$this->excel->getActiveSheet()->setTitle('AITAM');
		$this->excel->getActiveSheet()->setCellValue('A1', "LIST AITAM");
		...
		$filename='AITAM.xls'; //save our workbook as this file name
